...
__decorate([
    ...
    (0, module_1.ApiOperation)({ summary: 'Queue a notification for reliable delivery' }),
    (0, module_1.ApiResponse)({ status: 200, description: 'Notification queued successfully' }),
    (0, module_1.ApiBody)({
        schema: {
            type: 'object',
            properties: {
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, module_1.ApiOperation)({ summary: 'Get notification by ID' }),
    (0, module_1.ApiResponse)({ status: 200, description: 'Notification retrieved successfully' }),
    (0, module_1.ApiResponse)({ status: 404, description: 'Notification not found' }),
    (0, module_1.ApiParam)({ name: 'id', type: 'string' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, module_1.ApiOperation)({ summary: 'Get notifications by status' }),
    (0, module_1.ApiResponse)({ status: 200, description: 'Notifications retrieved successfully' }),
    (0, module_1.ApiQuery)({ name: 'status', type: 'string', required: false }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, module_1.ApiOperation)({ summary: 'Get notifications for a recipient' }),
    (0, module_1.ApiResponse)({ status: 200, description: 'Notifications retrieved successfully' }),
    (0, module_1.ApiParam)({ name: 'recipientId', type: 'string' }),
    (0, module_1.ApiQuery)({ name: 'recipientType', type: 'string', required: true }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, module_1.ApiOperation)({ summary: 'Cancel a notification' }),
    (0, module_1.ApiResponse)({ status: 200, description: 'Notification cancelled successfully' }),
    (0, module_1.ApiParam)({ name: 'id', type: 'string' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, module_1.ApiOperation)({ summary: 'Get notification statistics' }),
    (0, module_1.ApiResponse)({ status: 200, description: 'Notification statistics retrieved successfully' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, module_1.ApiOperation)({ summary: 'Process the notification queue' }),
    (0, module_1.ApiResponse)({ status: 200, description: 'Notification queue processed successfully' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
exports.NotificationQueueController = NotificationQueueController = __decorate([
    (0, module_1.ApiTags)('notification-queue'),
